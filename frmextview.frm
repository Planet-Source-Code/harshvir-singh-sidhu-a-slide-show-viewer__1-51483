...
Private Sub cmdchange_Click()
    ...
    frmmain.cmdextview.Caption = "&Images Selected"
    frmmain.cmdexit.Enabled = False
    frmmain.cmdfull.Enabled = False
    Unload Me
    frmmain.Show 1
End Sub
...
Private Sub cmdexitview_Click()
    On Error Resume Next
    frmmain.cmdextview.Caption = "&External Viewer"
    frmmain.cmdexit.Enabled = True
    frmmain.cmdfull.Enabled = True
    Unload Me
    frmmain.Show
End Sub
...
Private Sub cmdnext_Click()
    ...
    If current < tis - 1 Then
            ...
            Me.Caption = "MSP's External Viewer [ " & images(current) & " ]" '& " Resolution:  [ " & Int(ScaleX(picbox.Width - 4, vbTwips, vbPixels)) & " * " & Int(ScaleY(picbox.Height - 4, vbTwips, vbPixels)) & " ]"
            Image1.Stretch = True
            Image1.Refresh
            Image1.Visible = True
    Else
...
Private Sub Form_Load()
    ...
    Image1.Left = (Screen.Width - Image1.Width) / 2
    Image1.Picture = LoadPicture(images(current))
    Me.Caption = "MSP's External Viewer [ " & images(current) & " ]" '& " Resolution:  [ " & Int(ScaleX(picbox.Width - 4, vbTwips, vbPixels)) & " * " & Int(ScaleY(picbox.Height, vbTwips, vbPixels)) & " ]"
    Image1.Stretch = True
    Image1.Refresh
End Sub
